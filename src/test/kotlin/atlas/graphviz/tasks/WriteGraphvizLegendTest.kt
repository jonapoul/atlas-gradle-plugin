...
internal class WriteGraphvizLegendTest : ScenarioTest() {
  ...
  @Test
  fun `Show projects and links next to each other`() = GraphVizWithLinkTypes {
    // when
    assertThatTask("writeGraphvizLegend").buildsSuccessfully()
